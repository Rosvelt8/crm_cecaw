    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            width: sidebarOpen ? 36 : 34,
            height: sidebarOpen ? 36 : 34,
      ...
      <nav className="flex-1 overflow-y-auto py-2">
        {/* Dashboard link */}
        <div className={cn('px-2 pb-1', !sidebarOpen && 'px-1.5')}>
          {(() => {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  sidebarOpen ? 'pl-4 pr-3 py-2' : 'py-2.5 justify-end pr-2',
        ...
        {visibleGroups.map((group, i) => {
          ...
          return (
            <div key={group.id} className={cn(i > 0 && sidebarOpen && 'mt-5')}>
              {/* Group header */}
              {sidebarOpen ? (
                <button
              ...
              {(sidebarOpen ? isOpen : true) && (
                <div className={cn('space-y-[2px]', sidebarOpen ? 'px-2 pb-1' : 'px-1.5')}>
